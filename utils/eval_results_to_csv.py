...
Default behavior scans all `evaluation_results.json` under `model_predictions`.

Example:
    python .\\utils\\eval_results_to_csv.py --root model_predictions --out results_summary.csv
...
def main():
    ...
    parser.add_argument("--root", type=str, default="model_predictions", help="Root folder to search")
    parser.add_argument("--out", type=str, default="results_summary.csv", help="Output CSV path")
